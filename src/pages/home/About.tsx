...
export default function About() {
  return (
    <section className="my-20" id="percorso">
        <div className="flex gap-10 h-[340px]">
            <div className="p-[30px] px-10 bg-card-light flex flex-col gap-4 rounded-[34px] h-full  w-full flex-2">
            ...
            <div className="p-[30px] px-10 bg-surface flex flex-col gap-3 rounded-[34px] h-full w-full flex-2 border border-text/10">
