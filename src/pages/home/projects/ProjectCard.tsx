...
return (
    <article className={`border border-card-light/10 bg-surface rounded-[30px] flex flex-col gap-6 pt-6 pl-6 pb-8 max-h-[250px] relative after:w-[130px] after:h-[130px] after:absolute after:right-1/5 after:top-4 after:rounded-full after:blur-2xl after:bg-${color}`}>
        <span className={`text-${color} text-cyan text-lg font-extrabold`}>{formattedindex}</span>
